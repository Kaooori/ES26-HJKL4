...
--- SYSTEM OPERATION ---
> MENUS
In all menus of the program, you will be asked to enter an action that you wish to accomplish. Please input ONLY THE NUMBER of your preferred action to proceed. All other characters that are not indicated in the menu will be rejected by the program.

> ID NAMES
When inputting ID names to locate or delete a file, please follow the proper format indicated below (Always start with capital letter and input as a 3-digit number):
Customer ID : C-XXX
Venue ID : V-XXX
Event ID : E-XXX
Booking ID : B-XXX
...
> MOBILE NUMBERS
When inputting mobile numbers, this program strictly accepts Philippine numbers only. Please ensure that it follows the correct format of 11-digits, starting with "09".
